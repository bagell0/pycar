        ...
        if k == "1":
            ...
            while run1:
                ...
                if q == "w":
                    ...
                    print(f"pan: {px.pandir}, tilt: {px.tiltdir}") 
                if q == "s":
        ...
        if k == "2":
            ...
            while run2:
                ...
                if r == "a":
                    ...
                    print(f"The angle now is: {px.servodir}")
                if r == "d":
...
#The keyboard listener function. ChatGPT generated. I do not understand how it works
